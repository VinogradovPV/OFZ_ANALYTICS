...
Primary source для будущего web parser:
...
Текущий pipeline временно использует ручной источник Банка России и текстовую style policy для line+marker графиков.
