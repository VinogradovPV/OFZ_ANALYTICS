...
Параметры: `year`, `cumulative`, `2026-01-01`, ретроспектива `4`.
...
- Строки ДРПА: 66; они не должны смешиваться с demand-based ratios без проверки валидности спроса.
- Строки с нулевым или отрицательным размещением: 35; demand_to_placement_ratio по ним пустой.
