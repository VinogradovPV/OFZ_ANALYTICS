...
- `run_id`: `quality_gate_fast_month_cumulative_2026-05-01_r4_20260622_151148`
- `mode`: `fast`
...
| --- | --- | --- | --- |
| `encoding-mojibake` | `ok` | UTF-8/mojibake summary: checked=240, invalid_utf8=0, mojibake=0, allowed=0, fixed=0, problems=0 | `.\.venv\Scripts\python.exe scripts\qa\check_text_encoding.py` |
...
| `charts_structure` | `fail` | нет файлов: outputs/charts/index.md | - |
...
| `run_manifest` | `ok` | Latest manifest найден: 20260622_151111_99b65045. | - |
