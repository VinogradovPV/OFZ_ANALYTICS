...
Generated chart data exports must not be written directly to `outputs/exports/`.
The only files allowed directly in that folder are repository skeleton/navigation files:

- `.gitkeep`;
- `README.md`;
- `index.md`.

All generated CSV/XLSX/JSON exports must be placed in thematic subdirectories such as
`outputs/exports/chart_data/`, `outputs/exports/analytical_csv/` or dashboard export folders.
