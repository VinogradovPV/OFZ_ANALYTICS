...
Статус не должен писать OK, если проверялось только наличие old `data/processed/reference` files. Для dry-run сайта допустим текст: `Raw dataset не изменялся`.
