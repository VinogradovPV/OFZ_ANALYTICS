...
Вкладка Минфина сначала выполняет dry-run. Monthly download, annual-final replacement и manual import меняют controlled raw storage только после exact typed confirm. При HTTP 503 повторите dry-run позже: сайт Минфина временно недоступен, raw не изменен.
