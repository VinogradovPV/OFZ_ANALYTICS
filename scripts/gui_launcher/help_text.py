...
1. Обзор: проверить окружение и Git.
2. Минфин: проверить или обновить исходные данные.
3. Pipeline: запустить расчет.
4. Проверки качества: выполнить quality-fast или quality-full.
5. Отчеты и графики: проверить результаты.
6. Release: собрать пакет при необходимости.
7. Обслуживание: проверить staged artifacts перед commit.
...
Launcher logs: .ofz_launcher/logs/
...
На каждой вкладке есть блок: назначение, когда использовать, как запускать и что изменяется. Основные сценарии вынесены в первые кнопки. Инженерные параметры вроде URL override, HTML fixture, no network и max pages спрятаны в diagnostic/advanced sections и нужны только для расследований или аварийного обхода.
